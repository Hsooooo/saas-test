...
(
    code        VARCHAR(7)   NOT NULL COMMENT '코드' COLLATE 'utf8mb4_general_ci',
    first_code  VARCHAR(3)   NULL COMMENT '첫번째 코드' COLLATE 'utf8mb4_general_ci',
    second_code VARCHAR(2)   NULL COMMENT '두번째 코드' COLLATE 'utf8mb4_general_ci',
    third_code  VARCHAR(2)   NULL COMMENT '세번째 코드' COLLATE 'utf8mb4_general_ci',
    code_value   VARCHAR(100) NULL COMMENT '코드 값' COLLATE 'utf8mb4_general_ci',
...
(
    ...
    primary key,
    name         varchar(50)                          null comment '라이센스명' COLLATE 'utf8mb4_general_ci',
    description  varchar(255)                         null comment '라이센스 설명' COLLATE 'utf8mb4_general_ci',
    price        decimal(20, 10)                      null comment '라이센스 가격',
    unit_cd      varchar(7)                           null comment '화페 단위(code 테이블)' COLLATE 'utf8mb4_general_ci',
...
(
    ...
    primary key,
    email             varchar(255)                         not null comment '이메일주소' COLLATE 'utf8mb4_general_ci',
    password          varchar(100)                         null comment '회원 비밀번호' COLLATE 'utf8mb4_general_ci',
    name              varchar(50)                          null comment '회원 이름' COLLATE 'utf8mb4_general_ci',
    profile_image_url varchar(255)                         null comment '프로필 이미지 url' COLLATE 'utf8mb4_general_ci',
    type_cd           varchar(7)                           null comment '회원 구분(code 테이블)' COLLATE 'utf8mb4_general_ci',
    state_cd          varchar(7)                           null comment '회원 상태(code 테이블)' COLLATE 'utf8mb4_general_ci',
    comment           varchar(100)                         null comment '간략 소개' COLLATE 'utf8mb4_general_ci',
...
(
    ...
    state_cd        varchar(7)                           null comment '라이센스 상태(code 테이블)' COLLATE 'utf8mb4_general_ci',
...
(
    ...
    primary key,
    partnership_idx int                                  not null comment '파트너쉽 번호',
    name            varchar(50)                          null comment '직급명' COLLATE 'utf8mb4_general_ci',
...
(
    ...
    name            varchar(255)                         null comment '팀 이름' COLLATE 'utf8mb4_general_ci',
    team_image_url  varchar(255)                         null comment '팀 이미지 url' COLLATE 'utf8mb4_general_ci',
    team_image_path varchar(255)                         null comment '팀 이미지 경로' COLLATE 'utf8mb4_general_ci',
    update_date     datetime                             null comment '수정일',
    create_date     datetime default current_timestamp() not null comment '생성일',
...
(
    ...
    manager_cd               varchar(7)                           null comment '파트너쉽 관리구분(code 테이블)' COLLATE 'utf8mb4_general_ci',
    state_cd                 varchar(7)                           null comment '파트너쉽 회원상태(code 테이블)' COLLATE 'utf8mb4_general_ci',
    profile_image_url        varchar(255)                         null comment '프로필 이미지 url' COLLATE 'utf8mb4_general_ci',
    profile_image_path       varchar(255)                         null comment '프로필 이미지 경로' COLLATE 'utf8mb4_general_ci',
    phone                    varchar(255)                         null comment '사용자 휴대폰 번호' COLLATE 'utf8mb4_general_ci',
    disable_functions        varchar(1024)                        null comment '사용제한 라이센스 기능들(code 쉼표 구분)' COLLATE 'utf8mb4_general_ci',
    update_date              datetime                             null comment '수정일',
    create_date              datetime default current_timestamp() not null comment '생성일',
